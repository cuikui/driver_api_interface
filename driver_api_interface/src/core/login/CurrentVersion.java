...
public class CurrentVersion {
    ...
    public CurrentVersion() {
        ...
        parms = new HashMap<>();
        url = Constant.api_CurrentVersion;
    ...
    @Test(description = "获取当前版本， code返回412 正常 ")
...
//        Assert.assertTrue(jsonObject.getJSONObject("msg").getString("current_version").matches("[1-9][0-9]*"), "/Global/CurrentVersion接口报错，接口返回信息：" + response.toString());
      //TODO
    }
