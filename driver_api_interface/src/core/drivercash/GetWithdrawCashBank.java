 ...
 */
public class GetWithdrawCashBank {
    ...
    @Test(description = "获取可绑定到储蓄卡银行信息")
    public void test_getWithdrawCashBank() {
