 ...
 */
public class GetDriverAccountDetail {
    ...
    @Test(description = "我的钱包-司机账户账户明")
    public void test_getDriverAccountDetail() {
