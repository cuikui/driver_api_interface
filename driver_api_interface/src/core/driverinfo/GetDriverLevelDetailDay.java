 ...
 */
public class GetDriverLevelDetailDay {
    ...
    public void init() {
        ...
        parms.put("city", "北京市");
        parms.put("date", "20161103");
        parms.put("channel_source", "");
    }

    @Test(description = "司机每日经验值明细")
    public void test_getDriverLevelDetailDay() {
