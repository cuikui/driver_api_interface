 ...
 */
public class GetDecisionStatus {
    ...
    public GetDecisionStatus() {
        ...
        parms = new HashMap<>();
        url = Constant.api_OperateOrder_getDecisionStatus;
    ...
    public void init() {
        ...
        parms.put("service_order_id", "6348631238523899699");
    ...
    public void test_getDecisionStatus() {
