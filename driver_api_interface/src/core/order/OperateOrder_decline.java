 ...
 */
public class OperateOrder_decline {
    ...
    public void init() {
        ...
        parms.put("order_id","6348654126404833292");
        parms.put("in_coord_type","baidu");
        parms.put("method","decline");
    ...
    @Test(description = "司机拒单")
    public void test_perateOrder_decline() {
