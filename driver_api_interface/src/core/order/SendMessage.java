...
public class SendMessage {
    ...
    public void init() {
        ...
        parms.put("service_order_id", "6348673836009541878");
        parms.put("content", "很高兴为您服务，我会准时到达的。您有什么要求，可以在这里告诉我。");
        parms.put("is_crm", "0");
...
//        Assert.assertEquals(jsonObject.getInt("code"), 200, "response-->" + response + "\r\n" + "参数如下：" + HttpUtils.getPostParameter(parms));
        Assert.assertTrue((jsonObject.getInt("code") == 200) || (jsonObject.getInt("code") == 498)||(jsonObject.getInt("code") == 499), "response-->" + response + "\r\n" + "参数如下：" + HttpUtils.getPostParameter(parms));
